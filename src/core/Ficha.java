...
public class Ficha {
	...
	/**
	 * Funcion para representar graficamente una ficha
	 * Si numIzquierdo y numDerecho son distintos, la ficha se muestra en horizontal
	...
	/**
	 * Gira una ficha horizontal, intercambiando sus numeros, importante cuando
	 * se ponen fichas en el Tablero.
	 */
